...
not use `bun add @rekkr/orm` yet: the registry package is not the `v2.0.0`
...
bun add git+ssh://git@github.com/rekkrjs/orm.git#<tag>          # e.g. v2.0.0
...
git ls-remote git@github.com:rekkrjs/orm.git refs/tags/v2.0.0
```
