...
```bash
bun add github:rekkrjs/orm#v4.0.0
```
...
the `v4.0.0` release from this repository.
...
bun add github:rekkrjs/orm#<tag>          # e.g. v4.0.0
...
```bash
git ls-remote https://github.com/rekkrjs/orm.git refs/tags/v4.0.0
```
